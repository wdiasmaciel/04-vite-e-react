/** @typedef {import('../type/categoria-das-noticias-interface').Categoria} Categoria */

/** @type {Categoria[]} */
const categoriasDasNoticias = [
  {
